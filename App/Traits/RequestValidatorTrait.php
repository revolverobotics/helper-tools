...
trait RequestValidatorTrait
{
    ...
    public function validateStock(Request $request, array $rules, array $messages = [], array $customAttributes = [])
    {
    ...
    public function validateWithBag(
        ...
        $this->withErrorBag($errorBag, function () use ($request, $rules, $messages, $customAttributes) {
            $this->validateStock($request, $rules, $messages, $customAttributes);
        });
    }
